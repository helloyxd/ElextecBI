...
import com.jybi.job.core.rpc.netcom.jetty.client.JettyClient;
...
public class NetComClientProxy implements FactoryBean<Object> {
	private static final Logger logger = LoggerFactory.getLogger(com.jybi.job.core.rpc.netcom.NetComClientProxy.class);
