package com.jybi.job.core.executor;

import com.jybi.job.core.biz.AdminBiz;
import com.jybi.job.core.biz.ExecutorBiz;
import com.jybi.job.core.biz.impl.ExecutorBizImpl;
...
public class XxlJobExecutor implements ApplicationContextAware {
    private static final Logger logger = LoggerFactory.getLogger(com.jybi.job.core.executor.XxlJobExecutor.class);
