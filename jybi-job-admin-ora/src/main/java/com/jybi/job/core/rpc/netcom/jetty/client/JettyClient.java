package com.jybi.job.core.rpc.netcom.jetty.client;

import com.jybi.job.core.rpc.codec.RpcRequest;
import com.jybi.job.core.rpc.codec.RpcResponse;
import com.jybi.job.core.rpc.serialize.HessianSerializer;
import com.jybi.job.core.util.HttpClientUtil;
...
public class JettyClient {
	private static Logger logger = LoggerFactory.getLogger(com.jybi.job.core.rpc.netcom.jetty.client.JettyClient.class);
