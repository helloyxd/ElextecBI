...
public class GlueFactory {
	private static Logger logger = LoggerFactory.getLogger(com.jybi.job.core.glue.GlueFactory.class);
	...
	// ----------------------------- spring support -----------------------------
	private static com.jybi.job.core.glue.GlueFactory glueFactory = new com.jybi.job.core.glue.GlueFactory();
	public static com.jybi.job.core.glue.GlueFactory getInstance(){
		return glueFactory;
	}
