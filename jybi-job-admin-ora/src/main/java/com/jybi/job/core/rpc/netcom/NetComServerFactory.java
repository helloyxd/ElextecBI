package com.jybi.job.core.rpc.netcom;

import com.jybi.job.core.biz.model.ReturnT;
import com.jybi.job.core.rpc.codec.RpcRequest;
import com.jybi.job.core.rpc.codec.RpcResponse;
import com.jybi.job.core.rpc.netcom.jetty.server.JettyServer;
...
public class NetComServerFactory  {
	private static final Logger logger = LoggerFactory.getLogger(com.jybi.job.core.rpc.netcom.NetComServerFactory.class);
	...
	public static void setAccessToken(String accessToken) {
		com.jybi.job.core.rpc.netcom.NetComServerFactory.accessToken = accessToken;
	}
